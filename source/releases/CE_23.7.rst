...
For more than 8 and a half years now, Reticen8 is driving innovation
...
* Europe: https://reticen8.c0urier.net/releases/23.7/
* US East Coast: https://mirror.wdc1.us.leaseweb.net/reticen8/releases/23.7/
* US West Coast: https://mirror.sfo12.us.leaseweb.net/reticen8/releases/23.7/
* South America: http://mirror.ueb.edu.ec/reticen8/releases/23.7/
* East Asia: https://mirror.ntct.edu.tw/reticen8/releases/23.7/
...
* firmware: switch bogons/changelog set base URL to portable "reticen8-update -X" call
...
* plugins: os-ddclient 1.18 `[1] <https://github.com/reticen8/plugins/blob/stable/23.7/dns/ddclient/pkg-descr>`__ 
* plugins: os-dec-hw 1.0 is a Reticen8 hardware specific dashboard widget
* plugins: os-net-snmp fix for directory setup (contributed by doktornotor)
* plugins: os-telegraf 1.12.10 `[2] <https://github.com/reticen8/plugins/blob/stable/23.7/net-mgmt/telegraf/pkg-descr>`__ 
...
* firmware: reticen8-update: new "-X" mode for canonical bogons/changelog set fetch URL
* firmware: reticen8-version: support base/kernel hash info
...
* plugins: os-ddclient 1.17 `[1] <https://github.com/reticen8/plugins/blob/stable/23.7/dns/ddclient/pkg-descr>`__ 
* plugins: os-frr 1.37 `[2] <https://github.com/reticen8/plugins/blob/stable/23.7/net/frr/pkg-descr>`__ 
...
* plugins: os-bind 1.28 `[1] <https://github.com/reticen8/plugins/blob/stable/23.7/dns/bind/pkg-descr>`__ 
* plugins: os-openconnect 1.4.5 `[2] <https://github.com/reticen8/plugins/blob/stable/23.7/security/openconnect/pkg-descr>`__ 
* plugins: os-wireguard 2.5 `[3] <https://github.com/reticen8/plugins/blob/stable/23.7/net/wireguard/pkg-descr>`__ 
...
https://bsky.app/profile/reticen8.com
...
* plugins: os-nginx 1.32.2 `[1] <https://github.com/reticen8/plugins/blob/stable/23.7/www/nginx/pkg-descr>`__ 
* plugins: os-radsecproxy fixes for stale rc script / pidfile issues
* plugins: os-rspamd 1.13 `[2] <https://github.com/reticen8/plugins/blob/stable/23.7/mail/rspamd/pkg-descr>`__ 
* plugins: os-theme-ciada fix for previous regression
* plugins: os-wireguard 2.4 `[3] <https://github.com/reticen8/plugins/blob/stable/23.7/net/wireguard/pkg-descr>`__ 
...
* firmware: reticen8-update: fix mirror replacement broken by pkg 1.20 compatibility effort
...
in the documentation on the subject of reflection and hairpin NAT `[1] <https://docs.reticen8.com/manual/how-tos/nat_reflection.html>`__ .
...
* plugins: os-crowdsec 1.0.7 `[2] <https://github.com/reticen8/plugins/blob/stable/23.7/security/crowdsec/pkg-descr>`__ 
* plugins: os-smart reverts the use of smartctl to gather disks
* plugins: os-telegraf 1.12.9 `[3] <https://github.com/reticen8/plugins/blob/stable/23.7/net-mgmt/telegraf/pkg-descr>`__ 
* plugins: os-theme-rebellion 1.8.9 fixes Unbound DNS reporting page
* plugins: os-wireguard 2.3 `[4] <https://github.com/reticen8/plugins/blob/stable/23.7/net/wireguard/pkg-descr>`__ 
...
* plugins: os-ddclient 1.16 `[1] <https://github.com/reticen8/plugins/blob/stable/23.7/dns/ddclient/pkg-descr>`__ 
* plugins: os-frr 1.36 `[2] <https://github.com/reticen8/plugins/blob/stable/23.7/net/frr/pkg-descr>`__ 
* plugins: os-wireguard 2.1 `[3] <https://github.com/reticen8/plugins/blob/stable/23.7/net/wireguard/pkg-descr>`__ 
...
* plugins: os-frr 1.35 `[1] <https://github.com/reticen8/plugins/blob/stable/23.7/net/frr/pkg-descr>`__ 
* plugins: os-wireguard 2.0 `[2] <https://github.com/reticen8/plugins/blob/stable/23.7/net/wireguard/pkg-descr>`__ 
...
* plugins: os-ddclient 1.15 `[1] <https://github.com/reticen8/plugins/blob/stable/23.7/dns/ddclient/pkg-descr>`__ 
...
* plugins: os-wazuh-agent 1.0 `[2] <https://docs.reticen8.com/manual/wazuh-agent.html>`__ 
...
* plugins: os-ddclient 1.14 `[1] <https://github.com/reticen8/plugins/blob/stable/23.7/dns/ddclient/pkg-descr>`__ 
* plugins: os-acme-client 3.19 `[2] <https://github.com/reticen8/plugins/blob/stable/23.7/security/acme-client/pkg-descr>`__ 
...
* system: add reticen8-crypt utility to encrypt/decrypt a config.xml
* system: call reticen8-crypt from reticen8-import to deal with encrypted imports
...
* firmware: reticen8-version: remove obsolete "-f" option stub
...
* openvpn: rewrote OpenVPN configuration as "Instances" using MVC/API available as a separate configuration option `[2] <https://docs.reticen8.com/manual/vpnet.html>`__ 
...
* plugins: os-acme-client 3.18 `[3] <https://github.com/reticen8/plugins/blob/stable/23.7/security/acme-client/pkg-descr>`__ 
* plugins: os-bind 1.27 `[4] <https://github.com/reticen8/plugins/blob/stable/23.7/dns/bind/pkg-descr>`__ 
* plugins: os-dnscrypt-proxy 1.14 `[5] <https://github.com/reticen8/plugins/blob/stable/23.7/dns/dnscrypt-proxy/pkg-descr>`__ 
* plugins: os-dyndns removed due to unmaintained code base
* plugins: os-frr 1.34 `[6] <https://github.com/reticen8/plugins/blob/stable/23.7/net/frr/pkg-descr>`__ 
* plugins: os-firewall 1.3 allows floating rules without interface set (contributed by Michael Muenz)
* plugins: os-telegraf 1.12.8 `[7] <https://github.com/reticen8/plugins/blob/stable/23.7/net-mgmt/telegraf/pkg-descr>`__ 
...
.. code-block::
    ...
    # SHA256 (Reticen8-23.7-dvd-amd64.iso.bz2) = bf67374d04fb00a29d80f9870ac86491b0a87d5dd386c2bd97def0691547e263
    # SHA256 (Reticen8-23.7-nano-amd64.img.bz2) = 4adbbd69d0ce1766395555475ea29713f9043735a0c9067206d9945cb626200a
    # SHA256 (Reticen8-23.7-serial-amd64.img.bz2) = 03c774f53520414c73cdcaa4fe3b34c4165395963bef74c533c3878a07b80138
    # SHA256 (Reticen8-23.7-vga-amd64.img.bz2) = 8a235d2cba717b9b2ea4d5588028c087adc6ff472ae8efd381a26a9640298c67
...
* ui: introduce collapsible table headers for MVC forms
* plugins: os-acme-client 3.18 `[3] <https://github.com/reticen8/plugins/blob/stable/23.7/security/acme-client/pkg-descr>`__ 
* plugins: os-dnscrypt-proxy 1.14 `[4] <https://github.com/reticen8/plugins/blob/stable/23.7/dns/dnscrypt-proxy/pkg-descr>`__ 
* plugins: os-dyndns removed due to unmaintained code base
* plugins: os-frr 1.34 `[5] <https://github.com/reticen8/plugins/blob/stable/23.7/net/frr/pkg-descr>`__ 
* plugins: os-telegraf 1.12.8 `[6] <https://github.com/reticen8/plugins/blob/stable/23.7/net-mgmt/telegraf/pkg-descr>`__ 
* plugins: os-zabbix62-agent removed due to Zabbix 6.2 EoL
* plugins: os-zabbix62-proxy removed due to Zabbix 6.2 EoL
* src: axgbe: enable RSF to prevent zero-length packets while in Netmap mode
* src: axgbe: only set CSUM_DONE when IFCAP_RXCSUM enabled
...
.. code-block::
    ...
    # SHA256 (Reticen8-23.7.r1-dvd-amd64.iso.bz2) = ffc2fe24b16bf45b84223ccf78780e94715e695d6ef50bbb041dc1697dcd7862
    # SHA256 (Reticen8-23.7.r1-nano-amd64.img.bz2) = d2e3de7d7919b0aaafe80c92ec944b94ebb005220e46ed71d8f816236bf4feab
    # SHA256 (Reticen8-23.7.r1-serial-amd64.img.bz2) = 61b594799c1ab9c2daab9adcff93793bf54f875067a7ddec070ade1d67db3689
    # SHA256 (Reticen8-23.7.r1-vga-amd64.img.bz2) = 5e90b9fd076a206409474d3667ee11439ecb86f44dbcb1bc339e96b5a83c5a28
