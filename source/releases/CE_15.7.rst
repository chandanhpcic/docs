...
the forum `[9] <https://forum.reticen8.com/index.php?topic=1740>`__ .
...
* intrusion prevention (development): added Suricata 2.1beta4 in inline mode `[9] <https://forum.reticen8.com/index.php?topic=1740>`__ 
...
* languages: updated German and French to a newer version from
  translate.reticen8.com
* captive portal (development): added a new voucher implementation
* api (development): added API key authentication mechanism `[4] <https://wiki.reticen8.com/index.php/Howto_use_the_API>`__ 
...
* languages: updated German and French via https://translate.reticen8.com
...
you: the wait for System Health `[1] <https://reticen8.com/system-health-whats-next/>`__  is finally over and the best part is that
...
the new Firewall pages we have staged in our development version `[12] <https://forum.reticen8.com/index.php?topic=1305.0>`__ .
