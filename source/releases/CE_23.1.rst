...
For more than 8 years now, Reticen8 is driving innovation through
...
* Europe: https://reticen8.c0urier.net/releases/23.1/
* US East Coast: https://mirror.wdc1.us.leaseweb.net/reticen8/releases/23.1/
* US West Coast: https://mirror.sfo12.us.leaseweb.net/reticen8/releases/23.1/
* South America: http://mirror.ueb.edu.ec/reticen8/releases/23.1/
* East Asia: https://mirror.ntct.edu.tw/reticen8/releases/23.1/
...
* firmware: reticen8-update: move -K option to -x
* firmware: reticen8-update: support deferred kernel set install
* firmware: reticen8-update: use -w option with -a option in fetch(1)
* firmware: reticen8-update: ensure kernel directory consistency
...
* plugins: os-crowdsec 1.0.6 `[1] <https://github.com/reticen8/plugins/blob/stable/23.1/security/crowdsec/pkg-descr>`__ 
* plugins: os-nginx 1.32.1 `[2] <https://github.com/reticen8/plugins/blob/stable/23.1/www/nginx/pkg-descr>`__ 
...
* ports: strongswan upstream fix for VICI stalls `[13] <https://github.com/reticen8/core/issues/6308>`__ 
...
We are currently testing FreeBSD 13.2 for the upcoming Reticen8 23.7 and it
...
* plugins: os-crowdsec 1.0.5 `[1] <https://github.com/reticen8/plugins/blob/stable/23.1/security/crowdsec/pkg-descr>`__ 
* plugins: os-acme-client 3.17 `[2] <https://github.com/reticen8/plugins/blob/stable/23.1/security/acme-client/pkg-descr>`__ 
...
* plugins: os-ddclient 1.13 `[1] <https://github.com/reticen8/plugins/blob/stable/23.1/dns/ddclient/pkg-descr>`__ 
...
* firewall: allow to create aliases for logged-in OpenVPN users `[1] <https://docs.reticen8.com/manual/aliases.html#openvpn-group>`__ 
...
* plugins: os-bind 1.26 `[2] <https://github.com/reticen8/plugins/blob/stable/23.1/dns/bind/pkg-descr>`__ 
* plugins: os-crowdsec 1.0.4 `[3] <https://github.com/reticen8/plugins/blob/stable/23.1/security/crowdsec/pkg-descr>`__ 
* plugins: os-ddclient 1.12 `[4] <https://github.com/reticen8/plugins/blob/stable/23.1/dns/ddclient/pkg-descr>`__ 
* plugins: os-dnscrypt-proxy 1.13 `[5] <https://github.com/reticen8/plugins/blob/stable/23.1/dns/dnscrypt-proxy/pkg-descr>`__ 
* plugins: os-nginx 1.32 `[6] <https://github.com/reticen8/plugins/blob/stable/23.1/www/nginx/pkg-descr>`__ 
* plugins: os-upnp now allows subnet mask 0 in rules (contributed by Reiko Asakura)
* src: bridge: add support for emulated netmap mode `[7] <https://github.com/reticen8/src/commit/eebd4b140f>`__ 
...
* src: netmap: fix queue stalls with generic interfaces `[8] <https://github.com/reticen8/src/commit/cc92d78fa5>`__ 
...
* plugins: os-frr 1.33 `[1] <https://github.com/reticen8/plugins/blob/stable/23.1/net/frr/pkg-descr>`__ 
...
* plugins: os-api-backup 1.1 `[1] <https://github.com/reticen8/plugins/blob/stable/23.1/sysutils/api-backup/pkg-descr>`__ 
...
* ports: strongswan EAP-TLS upstream fix `[6] <https://github.com/reticen8/core/issues/6415>`__ 
...
* firmware: add stub for previously removed -f option in reticen8-version
...
* plugins: os-acme-client 3.16 `[1] <https://github.com/reticen8/plugins/blob/stable/23.1/security/acme-client/pkg-descr>`__ 
* plugins: os-crowdsec 1.0.2 `[2] <https://github.com/reticen8/plugins/blob/stable/23.1/security/crowdsec/pkg-descr>`__ 
* plugins: os-rfc2136 1.8 `[3] <https://github.com/reticen8/plugins/blob/stable/23.1/dns/rfc2136/pkg-descr>`__ 
...
* plugins: os-haproxy 4.1 `[1] <https://github.com/reticen8/plugins/blob/stable/23.1/net/haproxy/pkg-descr>`__ 
* plugins: os-openconnect 1.4.4 `[2] <https://github.com/reticen8/plugins/blob/stable/23.1/security/openconnect/pkg-descr>`__ 
* plugins: os-qemu-guest-agent 1.2 `[3] <https://github.com/reticen8/plugins/blob/stable/23.1/emulators/qemu-guest-agent/pkg-descr>`__ 
...
* system: introduce support tier annotations for core and plugins `[2] <https://docs.reticen8.com/support.html>`__ 
...
* plugins: os-bind 1.25 `[3] <https://github.com/reticen8/plugins/blob/stable/23.1/dns/bind/pkg-descr>`__ 
* plugins: os-ddclient 1.11 `[4] <https://github.com/reticen8/plugins/blob/stable/23.1/dns/ddclient/pkg-descr>`__ 
* plugins: os-dyndns end of life note moves to 23.7
* plugins: os-freeradius 1.9.22 `[5] <https://github.com/reticen8/plugins/blob/stable/23.1/net/freeradius/pkg-descr>`__ 
* plugins: os-frr 1.32 `[6] <https://github.com/reticen8/plugins/blob/stable/23.1/net/frr/pkg-descr>`__ 
* plugins: os-haproxy 4.0 `[7] <https://github.com/reticen8/plugins/blob/stable/23.1/net/haproxy/pkg-descr>`__ 
* plugins: os-puppet-agent 1.1 `[8] <https://github.com/reticen8/plugins/blob/stable/23.1/sysutils/puppet-agent/pkg-descr>`__ 
* plugins: os-sslh 1.0 `[9] <https://github.com/reticen8/plugins/blob/stable/23.1/net/sslh/pkg-descr>`__  (contributed by agh1467)
* plugins: os-theme-cicada 1.32 (contributed by Team Rebellion)
* plugins: os-upnp 1.5 `[10] <https://github.com/reticen8/plugins/blob/stable/23.1/net/upnp/pkg-descr>`__ 
...
.. code-block::
    ...
    # SHA256 (Reticen8-23.1-OpenSSL-dvd-amd64.iso.bz2) = f25c10113ef1ea13c031fc6102f8e6caf73a7296b12bcc287670026cab29c7c7
    # SHA256 (Reticen8-23.1-OpenSSL-nano-amd64.img.bz2) = 74ec824288adde409074f6855cb0110b860d0b28c33fbd6a30f12473a5e97d54
    # SHA256 (Reticen8-23.1-OpenSSL-serial-amd64.img.bz2) = 2b0ea23de4d09eed952f074e561d55b06b5d323bf9d68a2eae34c3118c304318
    # SHA256 (Reticen8-23.1-OpenSSL-vga-amd64.img.bz2) = 13b9f31651aa165862965566238eaecf66563a3b037fb7f8912a6d0440170bdb
...
* mvc: implement required getRealInterface() variant
* plugins: os-haproxy 4.0 `[1] <https://github.com/reticen8/plugins/blob/stable/23.1/net/haproxy/pkg-descr>`__ 
...
* ui: assorted improvements in bootgrid and form controls
* ui: switch to pure JSON data in bootgrids
* plugins: os-acme-client 3.15 `[2] <https://github.com/reticen8/plugins/blob/stable/23.1/security/acme-client/pkg-descr>`__ 
* plugins: os-bind 1.25 `[3] <https://github.com/reticen8/plugins/blob/stable/23.1/dns/bind/pkg-descr>`__ 
* plugins: os-ddclient 1.11 `[4] <https://github.com/reticen8/plugins/blob/stable/23.1/dns/ddclient/pkg-descr>`__ 
* plugins: os-dyndns end of life note moves to 23.7
* plugins: os-freeradius 1.9.22 `[5] <https://github.com/reticen8/plugins/blob/stable/23.1/net/freeradius/pkg-descr>`__ 
* plugins: os-upnp 1.5 `[6] <https://github.com/reticen8/plugins/blob/stable/23.1/net/upnp/pkg-descr>`__ 
* plugins: os-stunnel fixes missing include in certificate script
* plugins: os-wireguard switches to kernel module with a separate os-wireguard-go variant available for installation to keep the old behaviour
* plugins: os-sslh 1.0 `[7] <https://github.com/reticen8/plugins/blob/stable/23.1/net/sslh/pkg-descr>`__  (contributed by agh1467)
* src: assorted FreeBSD 13 stable fixes for e.g. bpf, bridge, bsdinstall ifconfig, iflib, ipfw, ipsec, lagg, netmap, pf, route and vlan components
...
.. code-block::
    ...
    # SHA256 (Reticen8-23.1.r1-OpenSSL-dvd-amd64.iso.bz2) = ed7d61d0107536c3095526d74c9d4e3b44cb86a7d8896bb51d65eccfd0a2056d
    # SHA256 (Reticen8-23.1.r1-OpenSSL-nano-amd64.img.bz2) = 66269b2eb434476d437cbf705af25b938e5d17436727eee565dd5e88fe8e6247
    # SHA256 (Reticen8-23.1.r1-OpenSSL-serial-amd64.img.bz2) = ca6676ae825241190e63b4fbedd8e727b28011fa484c35c1ef1e68e0355b1f4b
    # SHA256 (Reticen8-23.1.r1-OpenSSL-vga-amd64.img.bz2) = 5a4a8ec5f248484890d569b89f2fd1e29470bb95996c48def20686648e279f77
