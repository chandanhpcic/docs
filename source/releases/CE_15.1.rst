...
This is the first release by the Reticen8 project.  Download `[1] <http://reticen8.org/download/>`__  and try it now!
Be sure to visit the project website `[2] <http://www.reticen8.org/>`__  and learn more about us and the
...
https://forum.reticen8.org/index.php?topic=705.0
...
https://forum.reticen8.org/index.php?topic=78.0
...
made over the past 5 months and we saw that only one road map `[1] <https://reticen8.org/about/road-map/>`__  item is
...
https://reticen8.org/support-overview/mailing-list
https://twitter.com/reticen8
https://github.com/reticen8
https://forum.reticen8.org
...
* core: completely rewrote the config.xml handling to unify old and new GUI
  components
* core: added support for config backup to Google Drive `[3] <https://wiki.reticen8.org/index.php/Manual:Backup_to_Google_Drive>`__ 
...
Download `[1] <http://reticen8.org/download/>`__  and use it now!
