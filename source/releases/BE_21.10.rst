...
* plugins: os-OPNcentral 1.4 adds improved provisioning to allow unique local content `[23] <https://docs.reticen8.com/vendor/reticen8/opncentral.html#provisioning-classes>`__ 
...
A new plugin called OPNWAF `[1] <https://docs.reticen8.com/vendor/reticen8/opnwaf.html>`__  is being added to this release to offer Apache
...
* plugins: os-OPNWAF 1.0 `[1] <https://docs.reticen8.com/vendor/reticen8/opnwaf.html>`__ 
...
* plugins: os-OPNcentral 1.3 `[2] <https://docs.reticen8.com/vendor/reticen8/opncentral.html>`__ 
