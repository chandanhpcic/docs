...
* plugins: os-stunnel 1.0 `[6] <https://docs.reticen8.org/manual/how-tos/stunnel.html>`__  (sponsored by Incenter Technology)
...
* To prevent stale configuration files for remote syslog we advise to setup the new targets first `[9] <https://docs.reticen8.org/manual/settingsmenu.html#logging-targets>`__  and disable the old ones under System: Settings: Logging
