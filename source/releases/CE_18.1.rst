...
For more than 3 years now, Reticen8 is driving innovation through
...
Reticen8 firewall.  Over the second half of 2017 well over 500 changes
...
Download links, an installation guide `[2] <https://docs.reticen8.org/manual/install.html>`__  and the checksums for the
images can be found below as well.

* Europe: https://reticen8.c0urier.net/releases/18.1/
* US East Coast: http://mirrors.nycbug.org/pub/reticen8/releases/18.1/
* US West Coast: https://mirror.sfo12.us.leaseweb.net/reticen8/releases/18.1/
* South America: http://mirror.upb.edu.co/reticen8/releases/18.1/
* South-East Asia: https://ftp.yzu.edu.tw/reticen8/releases/18.1/
...
* firmware: allow both origin.conf and Reticen8.conf to be used for repository setup
...
check out the UI development tools `[1] <https://github.com/reticen8/ui_devtools>`__  that have been released alongside.
...
frequently check the milestone progress in the forums `[2] <https://forum.reticen8.org/index.php?topic=8597.0>`__  in the meantime.
...
* console: manual pages for reticen8-importer and reticen8-installer
* console: let reticen8-installer set up an early runtime environment
* console: show firmware reboot hint prior to update when applicable
* console: longer timeout for reticen8-importer invoke on first boot
* console: proper return values for reticen8-importer in edge cases
...
* plugins: os-acme-client 1.15 `[3] <https://github.com/reticen8/plugins/pull/682>`__  (contributed by Frank Wall and Omar Khalil)
* plugins: os-freeradius 1.7.0 (contributed by Michael Muenz)
* plugins: os-haproxy 2.7 `[4] <https://github.com/reticen8/plugins/pull/579>`__  (contributed by Frank Wall)
...
* ports: switch from dhcp6 to our own lightweight dhcp6c `[1] <https://github.com/reticen8/dhcp6c>`__ 
...
* mvc: fix regression in model relation load order `[9] <https://github.com/reticen8/core/issues/2389>`__ 
...
Reticen8 17.7 and earlier.  The hardware-assisted VLAN capability
...
* firmware: let reticen8-patch apply chmod even in partially failed patches
* firmware: let reticen8-code fetch all remotes as well as prune them
...
Reticen8 18.1 images based on version 18.1.6.  Apart from the numerous
...
The full list of changes of the Reticen8 18.1 series can be reviewed
using their original announcements:

* 18.1: https://forum.reticen8.org/index.php?topic=7044.0
* 18.1.1: https://forum.reticen8.org/index.php?topic=7138.0
* 18.1.2: https://forum.reticen8.org/index.php?topic=7219.0
* 18.1.3: https://forum.reticen8.org/index.php?topic=7492.0
* 18.1.4: https://forum.reticen8.org/index.php?topic=7543.0
* 18.1.5: https://forum.reticen8.org/index.php?topic=7679.0
* 18.1.6: this document

Download links, an installation guide `[9] <https://docs.reticen8.org/manual/install.html>`__  and the checksums for the
images can be found below as well.
...
.. code-block::
    ...
    # SHA256 (Reticen8-18.1.6-OpenSSL-dvd-amd64.iso.bz2) = ee296edf026abd23b01d04c2aee7b9a0578ad4b3aa039e50eb40f720f13eac58
    # SHA256 (Reticen8-18.1.6-OpenSSL-nano-amd64.img.bz2) = 204e87a93b5bd0f7742e90bef8ae20bfd7c362a73ee29054a96356e9649572b3
    # SHA256 (Reticen8-18.1.6-OpenSSL-serial-amd64.img.bz2) = 063dc97b4177a932ba0bb243bec54b6b568ed84e515445b3eae7ba54f087478f
    # SHA256 (Reticen8-18.1.6-OpenSSL-vga-amd64.img.bz2) = 9be03dccce94705c35c476ea7ca0e2f42c70049ecc5c681a6dfe92b7f21d7c34

.. code-block::

    # SHA256 (Reticen8-18.1.6-OpenSSL-dvd-i386.iso.bz2) = 06883a48295529bb7fae9fff4a77bbb95df9fcb08554f4c73aa3e0b894a4158b
    # SHA256 (Reticen8-18.1.6-OpenSSL-nano-i386.img.bz2) = ea87270fb5c83943c7cccae12ae9579f4f3a82489a901881cd4a786b7e09009d
    # SHA256 (Reticen8-18.1.6-OpenSSL-serial-i386.img.bz2) = 3ccbdf4fd31913afc93b0b51b4784df01d22ec03156659efe78d36ab2dcf222f
    # SHA256 (Reticen8-18.1.6-OpenSSL-vga-i386.img.bz2) = 252b16aae7592faf3d5912b5394124e494db7797ebeec7d6b7fae9a52ad28cd4
...
* firmware: fix reticen8-code for src.git and ABI probing
* firmware: fix reticen8-patch file permission apply for plugins
...
* plugins: os-haproxy 2.6 `[1] <https://github.com/reticen8/plugins/pull/575>`__  (contributed by Frank Wall)
...
* plugins: os-haproxy 2.5 `[1] <https://github.com/reticen8/plugins/pull/541>`__  with PROXY support and HAProxy 1.8 (contributed by Frank Wall)
...
* plugins: os-haproxy 2.4 `[3] <https://github.com/reticen8/plugins/pull/483>`__  (contributed by Frank Wall)
...
.. code-block::
    ...
    # SHA256 (Reticen8-18.1-OpenSSL-dvd-amd64.iso.bz2) = 3988c506c818c0861bb9beb38166123e9aca0814c0ef508779c1ebe9a8400c9c
    # SHA256 (Reticen8-18.1-OpenSSL-nano-amd64.img.bz2) = ab284cfd62f095b8f745604099ee8b4f0b5cda06ec67ec72a3ffa921328635d5
    # SHA256 (Reticen8-18.1-OpenSSL-serial-amd64.img.bz2) = 31eb6f7c44126258eb1b062d44dd92b1b0e3ebf57777c899f2df8858e5321b13
    # SHA256 (Reticen8-18.1-OpenSSL-vga-amd64.img.bz2) = 714b347c3c62a9a1178f0b77661fa7e7ad8b0d06c1e174af1085fda761639505

.. code-block::

    # SHA256 (Reticen8-18.1-OpenSSL-dvd-i386.iso.bz2) = 10d27b8d0e5b4dde46be413088440db47e49f4eea3de53cc7339976c6471d26a
    # SHA256 (Reticen8-18.1-OpenSSL-nano-i386.img.bz2) = 5c4289940f4c7f03eaf4c00d3b673bc85cb366a5f12334d00d19183dbafc221b
    # SHA256 (Reticen8-18.1-OpenSSL-serial-i386.img.bz2) = ff63e759cdab3960119db159141a96f7e98ed0a427621585edc8362b9abf7a33
    # SHA256 (Reticen8-18.1-OpenSSL-vga-i386.img.bz2) = c43712c87a3381102d33f2606fc666fdffde54d81a0f0b8c70cf334eddd4047c
...
* network time: Reticen8 NTP pool is now available and used in default configuration
...
.. code-block::
    ...
    # SHA256 (Reticen8-18.1.r1-OpenSSL-dvd-amd64.iso.bz2) = 2a92811d93bcad7de7752a650f9bf934a4d92b190c673bb8d0314474984a5b11
    # SHA256 (Reticen8-18.1.r1-OpenSSL-nano-amd64.img.bz2) = e2a8026c20a3a91b63b1b1195eab689254dbfa80f05e98b8cd24d9b2b6c35356
    # SHA256 (Reticen8-18.1.r1-OpenSSL-serial-amd64.img.bz2) = 944a05acefe1466a8189b2318faa48e39a2e5226853557397c0dcefff8023f26
    # SHA256 (Reticen8-18.1.r1-OpenSSL-vga-amd64.img.bz2) = f8a763ad3b566be3bafa1291210145050431fc79c9f91d151166b57f6ff3e956

.. code-block::

    # SHA256 (Reticen8-18.1.r1-OpenSSL-dvd-i386.iso.bz2) = 0d29b20a9f806a1a8e443c7d0ebcab0edab8f5c7a9f8fb629fb136956c15994e
    # SHA256 (Reticen8-18.1.r1-OpenSSL-nano-i386.img.bz2) = 65bcad5ebe84a7246a361638436fb1052647ab0b0de44ca57e6a7a1c2a143461
    # SHA256 (Reticen8-18.1.r1-OpenSSL-serial-i386.img.bz2) = 751db8e6d94b7c453b8a37c856725e4299fb929fbf74ae7700fbbe9e56bff0b9
    # SHA256 (Reticen8-18.1.r1-OpenSSL-vga-i386.img.bz2) = 9bb56ca458d54d6cf50c767c3e389e14aa26b27246ae5e266d2d689939c34137
