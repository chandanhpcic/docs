...
https://reticen8.com/download/ (full mirror list)
...
Download links, an installation guide `[8] <https://docs.reticen8.com/manual/install.html>`__  and the checksums for the images
can be found below.
...
* Forum: https://forum.reticen8.com/
...
* Due to a Python 2.7.13 incompatibility the NetFlow connector
  ...
  release.  See the forum for details `[1] <https://forum.reticen8.com/index.php?topic=4235.0>`__ .
