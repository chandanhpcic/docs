...
* firewall: new GeoIP settings page to allow continued use of upstream database `[1] <https://docs.reticen8.org/manual/how-tos/maxmind_geo_ip.html>`__ 
...
take a closer look `[1] <https://reticen8.org/about/road-map/>`__ .  More exciting for sure.  :)
...
* plugins: os-etpro-telemetry 1.4 `[4] <https://docs.reticen8.org/manual/etpro_telemetry.html>`__ 
...
* plugins: os-grid_example 1.0 `[1] <https://docs.reticen8.org/development/examples/using_grids.html>`__ 
* plugins: os-helloworld Python 3 compatibility `[2] <https://docs.reticen8.org/development/examples/helloworld.html>`__ 
* plugins: os-nut 1.5 adds Riello driver (contributed by Michael Muenz)
* plugins: os-sunnyvalley 1.0 `[3] <https://docs.reticen8.org/third_party_plugins.html>`__  `[4] <https://www.sunnyvalley.io/sensei>`__ 
