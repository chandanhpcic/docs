...
We generally advice to check the existing `issues <https://github.com/reticen8/core/issues>`__ and our `forum <https://forum.reticen8.org/>`__
before reporting new ones.

In case your issue was introduced after a (minor) upgrade, you can use `reticen8-revert <https://docs.reticen8.org/manual/reticen8_tools.html#reticen8-revert>`__
